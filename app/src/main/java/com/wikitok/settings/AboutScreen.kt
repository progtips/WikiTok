...
fun AboutScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Листайте, чтобы узнавать новое каждый день: факты, события, людей и явления из разных областей знаний. Отмечайте "+
                        "понравившиеся статьи, и приложение будет лучше подстраивать ленту под ваши интересы. Переходите к полным статьям в браузере в один тап.",
                style = MaterialTheme.typography.bodyMedium,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
                textAlign = TextAlign.Center
            )
